...
export const navigationItems: Array<{
  ...
  { id: "leaderboard", label: "Leaderboard", subtitle: "Friends & rankings", shortcutDigit: 6 },
  { id: "account", label: "Account", subtitle: "Sign in & sync", shortcutDigit: 4 },
];

export const trackingItems: NavigationItem[] = ["today", "calendar", "insights", "leaderboard"];
